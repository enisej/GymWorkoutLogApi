...
{
    /// <inheritdoc />
    public partial class CreateGymWorkoutSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseBodyPart", x => new { x.BodyPartId, x.ExerciseId });
                    table.ForeignKey(
                        name: "FK_ExerciseBodyPart_BodyParts_BodyPartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseBodyPart_ExerciseId",
